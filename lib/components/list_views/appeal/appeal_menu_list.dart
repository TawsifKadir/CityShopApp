...
class AppealMenuList extends StatelessWidget {
  final int menuIndex;
  final Function(int) onTap;
  final ScrollController scrollController;
  const AppealMenuList({required this.menuIndex, required this.onTap, required this.scrollController});
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemCount: appealMenuList.length,
