class ComplainedUser {
  ...
  int? permanentAddressDivisionId;
  String? permanentAddressDivisionNameBng;
  String? permanentAddressDivisionNameEng;
  int? permanentAddressDistrictId;
  String? permanentAddressDistrictNameBng;
  String? permanentAddressDistrictNameEng;
  int? permanentAddressTypeId;
  String? permanentAddressTypeNameBng;
  String? permanentAddressTypeNameEng;
  String? permanentAddressTypeValue;
  ...
  ComplainedUser.fromJson(json) {
    ...
    isAuthenticated = json['is_authenticated'] == true ? 1 : 0;
