...
class RejectScreen extends StatefulWidget {
  ...
  const RejectScreen({required this.complain, required this.viewPref, required this.typePref});
...
class _RejectScreenState extends State<RejectScreen> {
  ...
  void didChangeDependencies() {
    viewModel = Provider.of<RejectViewModel>(context, listen: false);
    modelData = Provider.of<RejectViewModel>(context);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Documented'.translate),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Documented reason'.translate, style: sl<TextStyles>().text16_400(black)),
          const SizedBox(height: 6),
          ModifiedTextField(minLines: 06, maxLines: 12, controller: viewModel.reason, hintText: hint),
