...
class SendForPermissionScreen extends StatefulWidget {
  final Complain complain;
  final ActionViewPref viewPref;
  final ActionTypePref typePref;
  const SendForPermissionScreen({required this.complain, required this.viewPref, required this.typePref});

  @override
  State<SendForPermissionScreen> createState() => _SendForPermissionScreenState();
}

class _SendForPermissionScreenState extends State<SendForPermissionScreen> {
  var viewModel = SendForPermissionViewModel();
  var modelData = SendForPermissionViewModel();
  ...
  void didChangeDependencies() {
    viewModel = Provider.of<SendForPermissionViewModel>(context, listen: false);
    modelData = Provider.of<SendForPermissionViewModel>(context);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Send For Permission'.translate),
