...
class EvidenceMaterialScreen extends StatefulWidget {
  final Complain complain;
  const EvidenceMaterialScreen({required this.complain});

  @override
  State<EvidenceMaterialScreen> createState() => _EvidenceMaterialScreenState();
}

class _EvidenceMaterialScreenState extends State<EvidenceMaterialScreen> {
  var viewModel = EvidenceMaterialViewModel();
  var modelData = EvidenceMaterialViewModel();
  ...
  void didChangeDependencies() {
    viewModel = Provider.of<EvidenceMaterialViewModel>(context, listen: false);
    modelData = Provider.of<EvidenceMaterialViewModel>(context);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Provide Material for Investigation'.translate),
